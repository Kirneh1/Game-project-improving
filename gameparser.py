...
def filter_words(words, skip_words):
    ...
    """
    filtered_words = [array_index for array_index in words if array_index not in skip_words]
...
def normalise_input(user_input):
    ...
    clean_array = lower_no_punct.split()
    clean_text = [array_index for array_index in clean_array if array_index not in skip_words]
